          ...
          <View style={{ flex: 1 }}>
            <View style={{ flex: 1 }}>
              <KeyboardAwareScrollView nestedScrollEnabled={true}>
                {((foodList==undefined || foodList.length == 0) && (exerciceList==undefined || exerciceList.length == 0) && loading == false ) ? (
                  <View style={{flex: 1}}>
                    ...
                    <Mytext 
                      text="Todavía no tienes ejercicios o comidas propias creadas. Pulsa el botón '+' para añadir uno nuevo." 
                      estilos={{
                        fontSize: 16,
                        fontWeight: 'bold',
                        color: '#d32f2f',
                  ...
                  <View>
                    <View style={{flexDirection: 'row', flex: 1, marginLeft: 20, marginBottom: 10, marginTop: 20}}>
                      <Switch
                        style={{alignSelf: 'flex-start', marginRight: 10, transform: [{ scaleX: 0.8 }, { scaleY: 0.8 }]}}
                        trackColor={{ true: '#000', false: '#999' }}
                        thumbColor={showFood ? '#d32f2f' : '#d32f2f'}
                    ...
                    {showFood ? (
                      <View>
                        {(foodList == undefined || foodList.length==0) ? (
                          <View style={{flex: 1}}>
                            ...
                            <Mytext 
                              text="Todavía no tienes comidas propias creadas. Pulsa el botón '+' para añadir una nueva." 
                              estilos={{
                                fontSize: 16,
                                fontWeight: 'bold',
                                color: '#d32f2f',
                      ...
                      <View>
                        {(exerciceList == undefined || exerciceList.length==0) ? (
                          <View style={{flex: 1}}>
                            <View style={{flex: 1, height: 300, marginTop: 40}}>
                              <Image
                                source={noResultsLogo}
                            ...
                            <Mytext 
                              text="Todavía no tienes ejercicios propios creadas. Pulsa el botón '+' para añadir uno nuevo." 
                              estilos={{
                                fontSize: 16,
                                fontWeight: 'bold',
                                color: '#d32f2f',
